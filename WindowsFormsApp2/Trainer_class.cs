...
namespace WindowsFormsApp2
{
    public class Trainer_class
    {
        ...
        public void SetExperience1(string value)
        {
            experience1 = value;
        }
        ...
        public void SetExperience2(string value)
        {
            experience2 = value;
        }
        ...
        public void SetExperience3(string value)
        {
            experience3 = value;
        }

        public string GetSpecilifyArea()
        {
            return Specilify_Area;
        }

        public void SetSpecilifyArea(string value)
        {
            Specilify_Area = value;
        }  
